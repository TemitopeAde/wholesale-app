                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <!-- Row 3 -->
                            <tr>
                                <td style="padding: 16px 8px 0 0; width: 33%; vertical-align: top;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px;">
                                        <tr>
                                            <td style="padding: 24px;">
                                                <div style="width: 44px; height: 44px; border-radius: 10px; background: #dcfce7; color: #16a34a; font-size: 20px; line-height: 44px; text-align: center; margin-bottom: 12px;">&#x1f4c2;</div>
                                                <h3 style="font-size: 16px; font-weight: 650; color: #111827; margin: 0 0 8px;">CSV Bulk Pricing</h3>
                                                <p style="font-size: 14px; color: #4b5563; line-height: 1.6; margin: 0;">Upload a CSV file to set fixed wholesale prices for hundreds of products at once. Map by SKU and import in seconds.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="padding: 16px 8px 0; width: 33%; vertical-align: top;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px;">
                                        <tr>
                                            <td style="padding: 24px;">
                                                <div style="width: 44px; height: 44px; border-radius: 10px; background: #fef9c3; color: #ca8a04; font-size: 20px; line-height: 44px; text-align: center; margin-bottom: 12px;">&#x1f3af;</div>
                                                <h3 style="font-size: 16px; font-weight: 650; color: #111827; margin: 0 0 8px;">Group-Targeted Discounts</h3>
                                                <p style="font-size: 14px; color: #4b5563; line-height: 1.6; margin: 0;">Assign any pricing or MOQ rule directly to one or more access groups. All members of that group automatically receive the discount.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="padding: 16px 0 0 8px; width: 33%; vertical-align: top;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px;">
                                        <tr>
                                            <td style="padding: 24px;">
                                                <div style="width: 44px; height: 44px; border-radius: 10px; background: #e0e7ff; color: #4338ca; font-size: 20px; line-height: 44px; text-align: center; margin-bottom: 12px;">&#x1f4e4;</div>
                                                <h3 style="font-size: 16px; font-weight: 650; color: #111827; margin: 0 0 8px;">Customer CSV Export</h3>
                                                <p style="font-size: 14px; color: #4b5563; line-height: 1.6; margin: 0;">Export your entire wholesale customer list to a CSV file for reporting, backup, or use in external tools like Excel or Google Sheets.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
                            ...
                            <tr>
                                <td style="padding: 24px;">
                                    ...
                                    <p style="font-size: 14px; color: #4b5563; line-height: 1.65; margin: 0 0 8px;">Rules can be applied to all customers or restricted to specific segments:</p>
                                    <ul style="padding-left: 20px; margin: 0 0 16px;">
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;"><strong>All Customers:</strong> Leave the Access Groups selector empty and the rule applies to every eligible wholesale customer.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;"><strong>Specific Access Groups:</strong> Select one or more access groups from the checklist in the rule form. The rule is applied only to members of those groups.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65;"><strong>Multiple Groups:</strong> A single rule can be assigned to multiple groups simultaneously. Each group member will receive the same discount.</li>
                                    </ul>
                ...
                <tr>
                    <td style="padding-bottom: 20px;">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
                            <tr>
                                <td style="padding: 20px 24px; border-bottom: 1px solid #f3f4f6;">
                                    <h3 style="font-size: 18px; font-weight: 650; color: #111827; margin: 0; display: inline;">CSV Bulk Pricing Upload</h3>
                                    <span style="font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 999px; text-transform: uppercase; letter-spacing: 0.5px; background: #dcfce7; color: #15803d; margin-left: 10px;">New</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 24px;">
                                    <p style="font-size: 14px; color: #4b5563; line-height: 1.65; margin: 0 0 16px;">The CSV Bulk Pricing Upload lets you set fixed wholesale prices for large numbers of products at once, without having to configure each product individually.</p>

                                    <h4 style="font-size: 15px; font-weight: 650; color: #1f2937; margin: 0 0 8px;">CSV File Format</h4>
                                    <p style="font-size: 14px; color: #4b5563; line-height: 1.65; margin: 0 0 8px;">Your CSV file must have exactly three columns in this order:</p>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; margin-bottom: 16px;">
                                        <tr>
                                            <td style="padding: 12px 16px; font-family: monospace; font-size: 13px; color: #374151;">
                                                <strong>sku, quantity, price</strong><br>
                                                EXAMPLE-SKU1, 10, 4.99<br>
                                                EXAMPLE-SKU2, 5, 12.50<br>
                                                WIDGET-RED-M, 25, 8.00
                                            </td>
                                        </tr>
                                    </table>
                                    <ul style="padding-left: 20px; margin: 0 0 16px;">
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;"><strong>sku:</strong> The product's SKU exactly as entered in your Wix store catalog.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;"><strong>quantity:</strong> Minimum quantity required for this price to apply.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65;"><strong>price:</strong> The fixed wholesale price per unit in your store currency.</li>
                                    </ul>

                                    <h4 style="font-size: 15px; font-weight: 650; color: #1f2937; margin: 0 0 8px;">How to Upload</h4>
                                    <ol style="padding-left: 20px; margin: 0 0 16px;">
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">Go to the <strong>Pricing Rules</strong> tab and click <strong>Add Rule</strong>.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">In the <strong>Rule Type</strong> dropdown, select <strong>Bulk Upload CSV (Fixed Prices)</strong>.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">Click <strong>Download Sample CSV</strong> to get a correctly formatted template.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">Fill in your SKUs and prices, then upload the file using the file picker.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">The system processes the file and maps each SKU to your store catalog. A success message confirms how many items were processed.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;">Optionally assign the rule to access groups and set a start/end date.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65;">Click <strong>Save</strong> to activate the bulk pricing rule.</li>
                                    </ol>

                                    <h4 style="font-size: 15px; font-weight: 650; color: #1f2937; margin: 0 0 8px;">SKU Matching &amp; Error Handling</h4>
                                    <p style="font-size: 14px; color: #4b5563; line-height: 1.65; margin: 0 0 16px;">The system looks up each SKU in your Wix product catalog. If a SKU cannot be matched, it is reported as "unfound". The upload is rejected if too many SKUs fail to match, ensuring your catalog stays accurate.</p>

                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; margin-bottom: 12px;">
                                        <tr><td style="padding: 14px 18px;">
                                            <strong style="display: block; margin-bottom: 4px; font-size: 14px; color: #1f2937;">Note</strong>
                                            <span style="font-size: 13px; color: #4b5563;">Bulk CSV pricing is only available when <strong>creating</strong> a new rule, not when editing an existing one. To update bulk prices, delete the old rule and create a new one with an updated CSV.</span>
                                        </td></tr>
                                    </table>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px;">
                                        <tr><td style="padding: 14px 18px;">
                                            <strong style="display: block; margin-bottom: 4px; font-size: 14px; color: #1f2937;">Tip</strong>
                                            <span style="font-size: 13px; color: #4b5563;">After uploading, assign the bulk pricing rule to one or more access groups so only your wholesale customers receive these prices &mdash; retail visitors will see the standard price.</span>
                                        </td></tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
                            ...
                            <tr>
                                <td style="padding: 24px;">
                                    ...
                                    <h4 style="font-size: 15px; font-weight: 650; color: #1f2937; margin: 0 0 8px;">Linking Pricing Rules to Groups</h4>
                                    <p style="font-size: 14px; color: #4b5563; line-height: 1.65; margin: 0 0 8px;">There are two ways to connect a pricing rule to an access group:</p>
                                    <ul style="padding-left: 20px; margin: 0 0 16px;">
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65; margin-bottom: 4px;"><strong>During rule creation:</strong> In the rule form, scroll to the <strong>Access Groups</strong> checklist and select one or more groups. The rule is automatically scoped to those groups when saved.</li>
                                        <li style="font-size: 14px; color: #4b5563; line-height: 1.65;"><strong>When editing a rule:</strong> Open any existing pricing or MOQ rule, check the desired access groups, and save. The updated membership list applies immediately.</li>
                                    </ul>
    ...
    <tr>
        <td align="center" style="padding: 48px 24px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 960px;">
                ...
                <!-- Workflow 4: CSV Bulk Pricing -->
                <tr>
                    <td style="padding-bottom: 20px;">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px;">
                            <tr>
                                <td style="padding: 24px;">
                                    <h3 style="font-size: 16px; font-weight: 650; color: #111827; margin: 0 0 20px;">Setting Per-Product Wholesale Prices via CSV</h3>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                                        <tr>
                                            ...
                                            <td style="padding-left: 16px; vertical-align: top;">
                                                <h4 style="font-size: 15px; font-weight: 650; color: #111827; margin: 0 0 4px;">Download the Sample CSV Template</h4>
                                                <p style="font-size: 14px; color: #4b5563; margin: 0;">Go to Pricing Rules &rarr; Add Rule &rarr; select "Bulk Upload CSV". Click <strong>Download Sample CSV</strong> to get a pre-formatted template file.</p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                                        <tr>
                                            ...
                                            <td style="padding-left: 16px; vertical-align: top;">
                                                <h4 style="font-size: 15px; font-weight: 650; color: #111827; margin: 0 0 4px;">Fill in SKUs and Prices</h4>
                                                <p style="font-size: 14px; color: #4b5563; margin: 0;">Open the template in Excel or Google Sheets. Add one row per product with the SKU (matching your Wix store exactly), the minimum quantity, and the wholesale price.</p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                                        <tr>
                                            ...
                                            <td style="padding-left: 16px; vertical-align: top;">
                                                <h4 style="font-size: 15px; font-weight: 650; color: #111827; margin: 0 0 4px;">Upload and Process</h4>
                                                <p style="font-size: 14px; color: #4b5563; margin: 0;">Upload your completed file. The app maps each SKU to your catalog and shows a confirmation message with the number of matched products.</p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                                        <tr>
                                            ...
                                            <td style="padding-left: 16px; vertical-align: top;">
                                                <h4 style="font-size: 15px; font-weight: 650; color: #111827; margin: 0 0 4px;">Assign to Access Groups (Optional)</h4>
                                                <p style="font-size: 14px; color: #4b5563; margin: 0;">Select which access groups should receive these prices. Leave blank to apply to all wholesale customers.</p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            ...
                                            <td style="padding-left: 16px; vertical-align: top;">
                                                <h4 style="font-size: 15px; font-weight: 650; color: #111827; margin: 0 0 4px;">Save and Activate</h4>
                                                <p style="font-size: 14px; color: #4b5563; margin: 0;">Click <strong>Save</strong>. The bulk pricing rule goes live immediately and eligible customers see the fixed wholesale prices at checkout.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding: 24px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 14px;">
                                        ...
                                        <tr>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #4b5563;">CSV Customer Export</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #4b5563;">CSV Bulk Pricing Upload</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                            <td style="padding: 10px 14px; border-bottom: 1px solid #e5e7eb; color: #10b981; font-weight: 700;">&#10003;</td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 14px; color: #4b5563;">Access Group Discount Targeting</td>
                            ...
                            <tr>
                                <td style="padding: 24px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr><td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;"><strong style="font-size: 15px; color: #111827;">Extended Fields</strong><br><span style="font-size: 14px; color: #4b5563;">Custom contact fields in Wix CRM used to store wholesale-specific data like customer type and group assignment.</span></td></tr>
                                        <tr><td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;"><strong style="font-size: 15px; color: #111827;">CSV Bulk Pricing</strong><br><span style="font-size: 14px; color: #4b5563;">A pricing rule type that lets you import fixed wholesale prices for multiple products at once by uploading a CSV file with columns: sku, quantity, price.</span></td></tr>
                                        <tr><td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;"><strong style="font-size: 15px; color: #111827;">SKU (Stock Keeping Unit)</strong><br><span style="font-size: 14px; color: #4b5563;">A unique identifier for each product variant in your Wix store. Used by the CSV bulk pricing feature to match rows in your upload file to specific products.</span></td></tr>
                                        <tr><td style="padding: 12px 0;"><strong style="font-size: 15px; color: #111827;">Group-Targeted Rule</strong><br><span style="font-size: 14px; color: #4b5563;">A pricing or MOQ rule that is restricted to specific access groups. Only members of the selected groups receive the discount or face the order requirement.</span></td></tr>
                                    </table>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding: 24px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr><td style="padding: 14px 0; border-bottom: 1px solid #f3f4f6;">
                                            <p style="font-weight: 600; color: #1f2937; margin: 0 0 6px; font-size: 15px;">How do I use CSV bulk pricing?</p>
                                            <p style="color: #4b5563; font-size: 14px; margin: 0;">Go to Pricing Rules, click Add Rule, and select <strong>Bulk Upload CSV (Fixed Prices)</strong> as the rule type. Download the sample CSV template, fill in your SKUs and wholesale prices (one row per product), and upload the file. The system maps each SKU to your catalog and creates fixed-price rules for every matched product. You can then assign the rule to specific access groups before saving.</p>
                                        </td></tr>
                                        <tr><td style="padding: 14px 0; border-bottom: 1px solid #f3f4f6;">
                                            <p style="font-weight: 600; color: #1f2937; margin: 0 0 6px; font-size: 15px;">How do I apply a discount rule to an entire access group?</p>
                                            <p style="color: #4b5563; font-size: 14px; margin: 0;">When creating or editing a pricing or MOQ rule, scroll to the <strong>Access Groups</strong> section and check the groups you want to target. The rule will automatically apply to every member of those groups. You can select multiple groups from the same rule.</p>
                                        </td></tr>
                                        <tr><td style="padding: 14px 0; border-bottom: 1px solid #f3f4f6;">
                                            <p style="font-weight: 600; color: #1f2937; margin: 0 0 6px; font-size: 15px;">Can a customer belong to more than one access group?</p>
                                            <p style="color: #4b5563; font-size: 14px; margin: 0;">Yes. Customers can be assigned to multiple access groups. All pricing rules that target any of those groups will apply to that customer at checkout.</p>
                                        </td></tr>
                                        <tr><td style="padding: 14px 0;">
                                            <p style="font-weight: 600; color: #1f2937; margin: 0 0 6px; font-size: 15px;">What happens if a SKU in my CSV doesn't match a product?</p>
                                            <p style="color: #4b5563; font-size: 14px; margin: 0;">Unmatched SKUs are reported as "unfound". If too many SKUs fail to match, the upload is rejected to prevent errors. Check that your SKUs match exactly what is entered in your Wix product catalog, including capitalization and hyphens.</p>
                                        </td></tr>
                                    </table>
                                </td>
                            </tr>
